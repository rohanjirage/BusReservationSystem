...
public interface JourneyDao extends JpaRepository<Journey, Integer> {
	...
	List<Journey> findByBusDepartureTimeGreaterThanEqualAndStatusNotIn(String departureTime, List<String> status);

	List<Journey> findByDepartureBusStopAndArrivalBusStopAndBusDepartureTimeBetweenAndStatusNotIn(
