            ...
            <table className="table table-hover text-color text-center">
              <thead className="table-bordered border-color bg-color custom-bg-text">
                <tr>
                  ...
                  <th scope="col">Back Fare (Rs.)</th>
                  <th scope="col">Middle Fare (Rs.)</th>
                  <th scope="col">Front Fare (Rs.)</th>
                ...
                {scheduledJourneys.map((journey) => {
                  return (
                    <tr>
                      ...
                      <td>
                        <b>{formatDateFromEpoch(journey.busDepartureTime)}</b>
                      </td>
                      <td>
                        <b>{formatDateFromEpoch(journey.busArrivalTime)}</b>
                      </td>
                      <td>
